...
class BudgetTransaction(Base):
    ...
    Stores financial transactions with original amounts, currency conversion to BGN,
    ...
    Attributes:
        ...
        currency: Currency code (3 chars, default 'BGN')
        amount_bgn: Amount converted to BGN (positive decimal)
    ...
    currency: Mapped[str] = mapped_column(String(3), default="BGN", nullable=False)
